...
const playWord = (speakMp3: string, setLoadingMp3: any) => {
  setLoadingMp3(true);
  ...
  var player = new Sound(speakMp3, undefined, error => {
    if (error) {
...
const getLexicalEntries = (def: any) => {
  const jsxEntries: any = [];
  ...
  if (Helper.isNotNullAndUndefined(def, ['results', '0', 'lexicalEntries'])) {
    ...
    lexicalEntries.forEach((lexicalItem: any, index: number) => {
      jsxEntries.push(
